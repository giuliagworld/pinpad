...
function (_Component) {
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args))), _defineProperty(_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      value: '',
      displayValue: '',
      letterCount: 0,
      disabled: false,
      ...
      _this.setState({
        value: _this.state.value + number,
        letterCount: _this.state.letterCount + 1
      });

      if (_this.state.letterCount <= 2) {
        _this.setState({
          displayValue: _this.state.displayValue + '*'
        });
      } else {
        _this.setState({
          displayValue: _this.state.displayValue + number
        });
      }

      if (_this.state.letterCount == 3) {
        _this.setState({
          disabled: true,
          attempsCount: _this.state.attempsCount + 1
        });

        setTimeout(function () {
          if (_this.state.value === _this.state.rightValue) {
            _this.setState({
              letterCount: 0,
              displayValue: 'OK',
              value: ''
            });
          } else if (_this.state.value !== _this.state.rightValue && _this.state.attempsCount <= 2) {
            _this.setState({
              displayValue: 'ERROR'
            });
          ...
          } else if (_this.state.value !== _this.state.rightValue && _this.state.attempsCount == 3) {
            _this.setState({
              displayValue: 'LOCKED'
            });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "h1"
      }, "Enter Pin"), _react.default.createElement("div", {
        className: "display"
      }, this.state.displayValue), _react.default.createElement("div", {
        className: "hidden"
        ...
        onClick: function onClick() {
          return _this3.addNumber(7);
        }
      }, "7"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(8);
        }
      }, "8"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(9);
        }
      }, "9"), _react.default.createElement("br", null), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(4);
        }
      }, "4"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(5);
        }
      }, "5"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(6);
        }
      }, "6"), _react.default.createElement("br", null), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(1);
        }
      }, "1"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(2);
        }
      }, "2"), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(3);
        }
      }, "3"), _react.default.createElement("br", null), _react.default.createElement("button", {
        className: "btn",
        disabled: this.state.disabled,
        onClick: function onClick() {
          return _this3.addNumber(0);
        }
      }, "0")));
    }
  }]);
